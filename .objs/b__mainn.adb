pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__mainn.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__mainn.adb");
...
--  BEGIN Object file/option list
   --   /media/main/src/ada/michau-cacl/.objs/mainn.o
   --   -L/media/main/src/ada/michau-cacl/.objs/
   --   -L/media/main/src/ada/michau-cacl/.objs/
   --   -L/usr/lib/gcc/x86_64-pc-linux-gnu/12.2.0/adalib/
   --   -static
   --   -lgnat
   --   -ldl
